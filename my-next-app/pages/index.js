...
const MapPage = ({ currentLanguage, onLanguageChange }) => {
    ...
    const {t: tindex} = useTranslation(currentLanguage, "index");
    ...
    // CSS styles for toggling visibility
    const mapStyle = {
    ...
    return (
        <div>
            ...
            {/* List View (hidden when map is displayed) */}
            <div style={listStyle}>
